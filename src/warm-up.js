...
var vegetables = ['carrots', 'brocolli', 'celery', 'brusell sprouts', 'green beans'];
...
// different fruits.
var fruits = ['grapes', 'strawberries', 'bananas', 'blueberries', 'watermelon', 'limes', 'peaches'];
...
// other key value pairs could be numOfEmployees, isHirng, managerName, etc.
